...
gps_task     = model.Task('gps'    , wcet = 2   , bcet = 2 , scheduling_parameter = 1)

lidar_task    = model.Task('lidar'  , wcet = 1   , bcet = 1 , scheduling_parameter = 1)

camera_task  = model.Task('camera', wcet = 2   , bcet = 2 , scheduling_parameter = 1)

pcu_task     = model.Task('pcu'         , wcet = 2   , bcet = 2 , scheduling_parameter = 1)

wifi_task       = model.Task('wifi'      , wcet = 2   , bcet = 2 , scheduling_parameter = 1)
...
gps_task.in_event_model = model.PJdEventModel(P = 10)
lidar_task.in_event_model = model.PJdEventModel(P = 10)
camera_task.in_event_model = model.PJdEventModel(P = 10)
pcu_task.in_event_model = model.PJdEventModel(P = 10)
wifi_task.in_event_model = model.PJdEventModel(P = 10)
